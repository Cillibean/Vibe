package com.cillibean.vibe.init;

import com.cillibean.vibe.VibeMod;
...
public class MushTE {
    public static final DeferredRegister<TileEntityType<?>> TILE_ENTITIES = DeferredRegister.create(ForgeRegistries.TILE_ENTITIES, VibeMod.MODID);
